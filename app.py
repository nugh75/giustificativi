...
with st.sidebar:
    ...
    if not st.session_state.smtp_configured:
        with st.form("smtp_form"):
            ...
            # Credenziali
            smtp_username = st.text_input("Email mittente", key="smtp_username")
...
with tab3:
    ...
    try:
        ...
        | tipo_percorso | Tipo di percorso formativo | PeF60 CFU, PeF30 CFU, PeF36 CFU o PeF30 CFU (art. 13) |
        ...
        - `indirizzo`
        - `tipo_lezione`
        - `tipo_percorso` (uno tra: "PeF60 CFU", "PeF30 CFU", "PeF36 CFU", "PeF30 CFU (art. 13)")
        - `classe_concorso`
        - `email`
        """)
